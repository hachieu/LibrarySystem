...
export class CardComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.cardService
      ...
      .subscribe(
        (res: HttpResponse<ICard[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICard[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
