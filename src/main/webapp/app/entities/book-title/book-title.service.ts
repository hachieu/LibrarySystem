...
export class BookTitleService {
  ...
  query(req?: any): Observable<EntityArrayResponseType> {
    ...
    return this.http
      .get<IBookTitle[]>(this.resourceUrl+"/search", { params: options, observe: 'response' })
  ...
  findByTop(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IBookTitle[]>(this.resourceUrl+"/find-top", { params: options, observe: 'response' })
      .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
  }
}
