...
public class Book implements Serializable {
    ...
    public Book(String bookBarCode, Integer status, LocalDate dateCreate, LocalDate dateUpdate, String userCreate,
            BookTitle bookTitle, BookCase bookCase, BorrowBook borrowBook) {
    ...
    public String toString() {
        return "Book{" + "id=" + getId() + ", bookBarCode='" + getBookBarCode() + "'" + ", status=" + getStatus()
                + ", dateCreate='" + getDateCreate() + "'" + ", dateUpdate='" + getDateUpdate() + "'" + ", userCreate='"
                + getUserCreate() + "'" + "}";
    }
}
