...
import { BookCategoryComponent } from 'app/entities/book-category/book-category.component';
...
describe('Component Tests', () => {
  describe('BookCategory Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bookCategories && comp.bookCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
