...
import { BookCategoryDeleteDialogComponent } from 'app/entities/book-category/book-category-delete-dialog.component';
  ...
  describe('BookCategory Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [BookCategoryDeleteDialogComponent],
      })
